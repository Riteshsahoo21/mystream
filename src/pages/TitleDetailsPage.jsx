...
export function TitleDetailsPage() {
  ...
  return (
    <AppShell>
      ...
      <section className="relative w-full min-h-[60vh] sm:min-h-[75vh] flex items-end pb-12 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#080B14]/90 via-[#080B14]/40 to-transparent" />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 w-full flex flex-col md:flex-row items-end gap-8">
          {/* Poster Artwork */}
          <div className="w-36 sm:w-56 aspect-[2/3] rounded-2xl overflow-hidden shadow-2xl border border-white/10 shrink-0 hidden sm:block">
            <MediaImage
          ...
          <div className="flex-1 max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-6xl font-display font-black text-white tracking-tight leading-tight mb-2">
              {media.title}
            </h1>

            {media.tagline && (
              <p className="text-sm sm:text-base text-[#22D3EE] italic mb-3">
                "{media.tagline}"
              </p>
            )}

            <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-gray-400 mb-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-[#22D3EE] to-[#8B5CF6] text-[#080B14] font-bold text-sm shadow-xl shadow-[#22D3EE]/25 hover:brightness-110 active:scale-95 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-3.5 rounded-xl bg-[#101626]/80 hover:bg-[#172033] text-white border border-white/10 text-sm font-medium backdrop-blur-md active:scale-95 transition-all cursor-pointer"
              >
              ...
              <button
                onClick={handleShare}
                className="p-3.5 rounded-xl bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white border border-white/10 transition-colors cursor-pointer"
                title="Share title"
              >
                <Share2 className="w-4 h-4" />
              </button>
              {copied && <span className="text-xs font-mono text-[#34D399]">Copied link!</span>}
            </div>
          </div>
        </div>
      </section>
